...
use Pintushi\Bundle\SearchBundle\Entity\Query as QueryLog;
use Pintushi\Bundle\SearchBundle\Event\BeforeSearchEvent;
...
abstract class AbstractEngine implements EngineInterface
{
     ...
     * Must return array
     * array(
     *   'results' - array of Pintushi\Bundle\SearchBundle\Query\Result\Item objects or callable to get it
    ...
    {
        $entityManager = $this->registry->getManagerForClass('Pintushi\Bundle\SearchBundle\Entity\Query');
