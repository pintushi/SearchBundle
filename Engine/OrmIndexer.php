...
class OrmIndexer extends AbstractIndexer
{
    ...
    {
        $query = <<<EOF
DELETE FROM pintushi_search_index_integer  WHERE item_id IN (SELECT DISTINCT id FROM pintushi_search_item WHERE entity = ?);
DELETE FROM pintushi_search_index_datetime WHERE item_id IN (SELECT DISTINCT id FROM pintushi_search_item WHERE entity = ?);
DELETE FROM pintushi_search_index_decimal  WHERE item_id IN (SELECT DISTINCT id FROM pintushi_search_item WHERE entity = ?);
DELETE FROM pintushi_search_index_text     WHERE item_id IN (SELECT DISTINCT id FROM pintushi_search_item WHERE entity = ?);
DELETE FROM pintushi_search_item           WHERE entity = ?;
EOF;
