...
use Pintushi\Bundle\SearchBundle\Event\PrepareEntityMapEvent;
use Pintushi\Bundle\SearchBundle\Exception\InvalidConfigurationException;
 ...
 *
 * @package Pintushi\Bundle\SearchBundle\Engine
 */
class ObjectMapper extends AbstractMapper
{
    ...
    public function mapObject($object)
    {
        ...
        if (is_object($object) && $this->mappingProvider->hasFieldsMapping($objectClass)) {
            ...
            /**
             *  Dispatch pintushi_search.prepare_entity_map event
             */
