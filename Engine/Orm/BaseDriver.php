...
use Pintushi\Bundle\SearchBundle\Exception\ExpressionSyntaxError;
use Pintushi\Bundle\SearchBundle\Query\Criteria\Criteria;
...
abstract class BaseDriver implements DBALPersisterInterface
{
    ...
    /**
     * Pintushi\Bundle\SearchBundle\Entity\AbstractItem data to be stored into db
     *
     * @var array
     * [
     *     spl_object_hash => [
    ...
    public function initRepo(EntityManagerInterface $em, ClassMetadata $class)
    {
        if (!is_a($class->name, AbstractItem::class, true)) {
            throw new \InvalidArgumentException(
                'ClassMetadata doesn\'t represent Pintushi\Bundle\SearchBundle\Entity\Item class or its descendant'
            );
        }
    ...
    /**
     * @param \Pintushi\Bundle\SearchBundle\Query\Query $query
     * @param boolean                              $setOrderBy
     *
