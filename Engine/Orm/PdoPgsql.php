...
class PdoPgsql extends BaseDriver
{
    ...
    public function initRepo(EntityManagerInterface $em, ClassMetadata $class)
    {
        ...
        $ormConfig->addCustomStringFunction(
            'TsvectorTsquery',
            'Pintushi\Bundle\SearchBundle\Engine\Orm\PdoPgsql\TsvectorTsquery'
        );
        $ormConfig->addCustomStringFunction('TsRank', 'Pintushi\Bundle\SearchBundle\Engine\Orm\PdoPgsql\TsRank');
     ...
     * @return string
     */
    public static function getPlainSql($tableName = 'pintushi_search_index_text', $indexName = 'value')
    {
